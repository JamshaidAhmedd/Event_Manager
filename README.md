...
This demo Express application provides a simple event management system with organiser and attendee sections. The organiser dashboard uses the AdminKit template for a modern sidebar layout.
